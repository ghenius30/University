...
<body>
            ...
            <div class="lenyilo_menu">
                ...
                <div class="menu_lista">
                    <ul id="mainmenu">
                        ...
                        <li><a href="movies.php" class="current">Filmek</a></li>
    ...
    <aside>
        <div>
            <h3>Legújabb filmek</h3><?php
            $data=read_file();

            if (!(empty($data))) {
                foreach ($data as $datatype) {
                    if (array_keys($datatype)[0] === "movies") {
                        foreach ($datatype as $actual) {
                            $ID = $actual["ID"];
                            $release = $actual["release"];
                            $darabok = explode(".", $release);
                            $title = $actual["title"] . " (". $darabok[0] . ")";
                            if (preg_match("/(202.)/", $release)) {?>
